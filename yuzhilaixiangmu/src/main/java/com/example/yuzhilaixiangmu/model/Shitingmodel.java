...
public class Shitingmodel {

    private String upperCase;

    public  void  getshitingModel(final Onfinsh onfinsh, String url, String id, String key){
      ...
      //  stringBuffer.append("001");
        ...
        Flowable<ShitingBean> flowable = apiservce.getshiting(id, "12345", "1", l + "", "10", "0", upperCase);
        flowable.subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeWith(new DisposableSubscriber<ShitingBean>() {
                    @Override
                    public void onNext(ShitingBean shitingBean) {
                        onfinsh.Onseccess(shitingBean);
                    }
